        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
            <ul class="nav navbar-nav">
                <li><a href="<?= base_url('viewer') ?>">Home</a></li>
                <li><a href="<?= base_url('Kategoriviewer') ?>">Kategori</a></li>
                <li><a href="<?= base_url('Depviewer') ?>">Departement</a></li>
                <li><a href="<?= base_url('Arsipviewer') ?>">Arsip</a></li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
        <!-- Navbar Right Menu -->
